...
const ReadDeviceIdentificationRequest = require('../dist/request/read-device-identification.js').default
const ReadDeviceIdentificationResponse = require('../dist/response/read-device-identification.js').default
