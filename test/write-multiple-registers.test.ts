...
import WriteMultipleRegistersRequestBody from '../src/request/write-multiple-registers'
...
describe('WriteMultipleRegisters Tests.', function () {
  ...
  describe('WriteMultipleRegisters Request', function () {
    it('should create a buffer from a write multiple registers message', function () {
      const request = new WriteMultipleRegistersRequestBody(10, [0x0001, 0x0002, 0x1234, 0x4321])
    ...
    it('should create a message from a buffer', function () {
      ...
      const message = WriteMultipleRegistersRequestBody.fromBuffer(buffer)
